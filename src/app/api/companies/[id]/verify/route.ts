...
import { verifyCompanyRegistry } from "@/features/enrichment/server/service";
...
export async function POST(request: Request, { params }: RouteContext) {
  ...
  try {
    ...
    return NextResponse.json(await verifyCompanyRegistry(context, id, parsed.data.idempotencyKey));
  } catch (error) {
