...
-- seed_phase6_demo: ce bloc reste nommé pour la traçabilité des tests de migration.
do $phase6$
begin
insert into public.mail_threads (
  id,
...
-- seed_phase7_demo: ce bloc reste nommé pour la traçabilité des tests de migration.
do $phase7$
declare
  owner_user_id uuid;
begin
...
-- seed_phase8_demo: conformité, rétention et preuves de démonstration.
do $phase8$
declare
  owner_user_id uuid;
begin
